...
@section('content')
    <div class="space-y-8 min-h-screen p-6">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div>
                ...
                <p class="mt-2 text-sm text-stone-600">Create a new product or item for your inventory</p>
            </div>
                ...
                <div class="p-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="dropzone-area border-2 border-dashed rounded-xl p-8 text-center cursor-pointer transition-all duration-300 hover:border-stone-400"
                                    ...
                                    <p class="text-xs text-stone-400">Allowed formats: JPG, JPEG, PNG, WEBP. Multiple
                                        images allowed.</p>
                                </div>
                                @error('images.*')
                                    <p class="mt-1 text-xs text-rose-600">{{ $message }}</p>
                    ...
                    <div class="mt-8">
                        ...
                        <textarea name="description" id="description" rows="5"
                            ...
                            style="focus:ring-color: #3a2819;" placeholder="Enter product description...">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-xs text-rose-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="form-group mt-4">
                        ...
                        <select name="model" id="type" class="form-control @error('model') is-invalid @enderror">
                            <option value="">— Select Item Type —</option>
                            <option value="New" {{ old('model') == 'New' ? 'selected' : '' }}>New</option>
                            <option value="Best Seller" {{ old('model') == 'Best Seller' ? 'selected' : '' }}>Best Seller
                            </option>
                            <option value="Hot Deal" {{ old('model') == 'Hot Deal' ? 'selected' : '' }}>Hot Deal</option>
                        </select>
                        @error('model')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                                ...
                                <div class="flex items-center gap-4 p-3 bg-stone-50 rounded-xl border border-stone-200">
                                    ...
                                    <div class="flex-1">
                                        <input type="number" name="warehouse_quantities[{{ $warehouse->id }}]"
                                            value="{{ old('warehouse_quantities.' . $warehouse->id, 0) }}"
                                    ...
                                    <div class="spec-row flex flex-col md:flex-row gap-3">
                                        ...
                                        <div class="flex-1">
                                            <input type="text" name="spec_value[]"
                                                class="w-full px-4 py-2 bg-stone-50 border border-stone-200 rounded-lg focus:outline-none focus:ring-2"
                                                style="focus:ring-color: #3a2819;" placeholder="Value (e.g., Nike)"
    ...
    <script>
        ...
        // SKU similarity warning (non‑blocking)
