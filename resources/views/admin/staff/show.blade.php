...
<div class="staff-detail-wrapper">
    ...
    <div class="detail-card">
        ...
        <div class="detail-card-body">
            ...
            <div class="detail-row">
                <span class="detail-label">Assigned Warehouse</span>
                <span class="detail-value">
                    @if($user->warehouse)
                    {{ $user->warehouse->name }}
                    <span style="color:#8b735a; font-size:0.75rem;">({{ $user->warehouse->code }})</span>
                    @if(!$user->warehouse->is_active)
                    <span class="badge-inactive"
                        style="background:#f0e6dc; padding:2px 8px; border-radius:20px; margin-left:8px; font-size:0.7rem;">Inactive</span>
                    @endif
                    @else
                    <span style="color:#a58f76;">— No warehouse assigned —</span>
                    @endif
                </span>
            </div>
            <div class="detail-row">
