    ...
    <div class="container-fluid px-4">
        ...
        @forelse ($orders as $order)
            ...
            <div class="order-card">
                ...
                {{-- Items Table --}}
                @if ($order->user->account_type === 'b2b')
                    <div
                        style="padding:1rem; background:#fff; border:1px solid var(--border); border-radius:6px; margin-bottom:1rem;">
                        <p style="margin:0 0 8px; color:var(--muted);">B2B order — manage allocations and shipping from the
                            order details.</p>
                        <a href="{{ route('admin.orders.show', $order->id) }}" class="btn-bronze-outline">Open Order
                            Details</a>
                    </div>
                @else
                                                ...
                                                <div class="dispatch-group" data-order-item-id="{{ $item->id }}"
                                                    ...
                                                    <div class="allocations-list">
                                                        <div class="allocation-row" data-index="0"
                                                            ...
                                                            <button type="button"
                                                                class="btn-bronze-outline remove-allocation"
                                                            ...
                                                            <input type="number" class="dispatch-input allocation-qty"
                                                                ...
                                                                value="{{ $maxDispatch }}" style="width:76px;" />

                                                        </div>
                                                    </div>
                                                    <button class="btn-dispatch dispatch-btn"
                                                        data-id="{{ $item->id }}" style="margin-left:8px;">
