...
<body>
    @php
        ...
        |--------------------------------------------------------------------------
        | Variables expected: 
        |   $user (object with full_name property)
        |   $item (object with name and sku properties)
        */
        $userName = $user->full_name ?? ($user->name ?? 'Valued Customer');
    ...
    <div class="email-wrapper">
        ...
        <div class="hero">
            ...
            <div class="hero-body">
                ✦ Your requested piece has returned to our collection. ✦
            </div>
        </div>
            ...
            <div class="stock-card">
                ...
                <div class="item-info">
                    <div class="info-row">
                        ...
                        <span class="info-value">{{ $itemSku }}</span>
                    </div>
                </div>
                
                <div class="alert-message">
                    Don't let it slip away again — hurry before it goes out of stock.
                </div>
